/**
 * Shapem — Auto-generate recipes.json from data.js
...
// Write temp module
const tmpPath = path.join(baseDir, '_tmp_shapem_data.js');
...
const output = {
  ...
  platform:      'Shapem',
  website:       'https://shapem.netlify.app',
  description:   'Shapem global recipe database — auto-generated JSON',
