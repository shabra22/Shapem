...
2. Drag and drop your entire `gieeskrecipes` folder onto the Netlify dashboard
3. Your site goes live instantly (e.g. gieeskrecipes.netlify.app)
4. Then update Supabase:
   - Authentication → URL Configuration
   - Site URL: https://gieeskrecipes.netlify.app
   - Redirect URLs: https://gieeskrecipes.netlify.app/*
...
1. Push gieeskrecipes folder to a GitHub repo
2. Settings → Pages → enable from main branch
3. Update Supabase URLs as above

## Google Cloud OAuth — add your live domain later
Once deployed, go to Google Cloud Console → Credentials → your GieesK Recipes OAuth client
and add:
